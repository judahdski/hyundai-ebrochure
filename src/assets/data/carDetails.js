            ...
            highlight: [
                {
                    ...
                    body: "Tunjukkan faktor X dalam dirimu bersama Hyundai STARGAZER X. Desain baru berkarakter tegas namun tetap stylish dan futuristik, dilengkapi dengan beragam fitur inovatif membuat eksplorasi dalam hidup lebih menyenangkan.",
                    images: ["section1_highlight_creta.jpg"],
                },
                {
                    code: "highlight_segment_2",
                    title: "Bluelink <br> Connect with your car.",
                    body: "Hyundai STARGAZER X telah dilengkapi dengan teknologi konektivitas Hyundai Bluelink, sebuah platform yang memudahkan pengecekan informasi penting tentang mobil Anda. Terhubung dengan call center Hyundai 7 x 24 jam saat terjadi kondisi darurat untuk segera memberikan Anda bantuan.",
                    images: ["section2_highlight_creta.jpg"],
                },
            ],
            gallery: {
                ...
                article: [
                    {
                        ...
                        body: "STARGAZER X tampil dengan desain eksterior baru X Dedicated Design menjadi simbol dari semangat baru untuk mengekspresikan jati dirimu yang sesungguhnya.",
                        img: ["creta_article_gallery"],
                    },
                ],
                eksterior: [
