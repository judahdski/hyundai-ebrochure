...
const MainCarDetails = () => {
	return (
		<div className='w-full max-w-[1280px]'>
			<CarDetailNavigator />
			<p className='p-[72px] flex flex-col gap-[72px]'>
				<div className='flex flex-col gap-8 items-center'>
					<h3 className='text-[32px] font-medium'>Bintang baru keluarga.</h3>
					<p className='leading-6'>
						Saatnya menikmati era baru MPV bersama New STARGAZER, inovasi mobilitas untuk setiap perjalanan berkualitas. Inilah standar baru mobil keluarga yang menghadirkan kenyamanan maksimal dan fitur berkelas, serta
				...
				<div className='flex flex-col gap-8 items-center'>
					...
					<p className='leading-6'>
						New STARGAZER telah dilengkapi dengan teknologi konektivitas Hyundai Bluelink, sebuah platform yang memudahkan pengecekan informasi penting tentang mobil Anda. Terhubung dengan call center Hyundai 7 x 24 jam saat
						terjadi kondisi darurat untuk segera memberikan Anda bantuan.
					</p>
