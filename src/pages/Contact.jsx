...
const Contact = () => {
  ...
  const OnTextAreaChange = (e) => {
    ...
    setMessage(`Halo mas, perkenalkan nama saya ${userName}, ${userMessage}`);
  };
      ...
      <div className='md:w-1/2'>
        ...
        <div className='md:h-[262.5px] pt-4 pb-12 md:pb-8 px-6 md:px-[72px] border-b-2 border-[#EDF3FA] flex flex-col justify-end gap-6'>
          ...
          <div className='flex flex-col items-center md:items-start gap-1.5 md:gap-2'>
            ...
            <p className='text-sm md:text-base text-[#3F3E3E] font-medium'>
              {salesProfile.role}
            </p>
          </div>
          {/* nama dan title */}
        ...
        <div className='pt-[48px] pb-[56px] md:py-8 px-4 md:px-16'>
          <form className='bg-[#EDF3FA] rounded-2xl p-4 flex flex-col gap-4'>
            ...
            <WAButton
              customClassName={
                'mt-2 p-4 bg-[#3165AF] rounded-lg text-white text-base text-center font-medium'
              }
              content={'Kirim Pesan'}
              waMessage={message}
            />
